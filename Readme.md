...
* Студент: [Фёдор Николаевич](https://up.htmlacademy.ru/htmlcss/21/user/193253).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/193253-technomart) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
...
# Technomart
Доработка моего выпускного проекта 2014 года с курсов HTML Academy
